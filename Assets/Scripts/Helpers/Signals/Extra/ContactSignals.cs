...
namespace Helpers.Signals.Extra
{
    /// <summary>
    ...
    public static class ContactSignals
    {
        ...
        /// <returns></returns>
        public static ContactSignal AddCollisionEnterSignal(this GameObject gameObject)
        {
            var g = gameObject.AddComponent<CollisionEnter>();
            return g.signal;
        }
        ...
        public abstract class ContactListenerBase : MonoBehaviour
        {
            ...
            /// Contact Signal.
            /// </summary>
            public readonly ContactSignal signal = new ContactSignal();
